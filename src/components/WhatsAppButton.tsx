...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed right-5 z-40 grid size-12 place-items-center rounded-full bg-[#25D366] text-white shadow-[0_8px_30px_-6px_rgba(37,211,102,0.55)] transition-all duration-300 ease-[var(--ease-out-soft)] hover:scale-110 sm:right-6 sm:size-14"
    >
